...
#: LOG_UNIT: the ``LOG_UNIT`` setting is deprecated. Use the ``LOG_UNITS`` dictionary instead.
LOG_UNIT = "% full"

#: LOG_UNITS: The ``LOG_UNITS`` setting is a dictionary which maps an internal definition of a measurement type
